<?php /* Smarty version Smarty3rc4, created on 2011-03-10 16:12:41
         compiled from "/srv/sargodarya.de/www/karmalicious/smarty/templates/levels.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19808130274d78ea699bc039-20292038%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a20ec25f35e9082f1e23b4953f18ce086bdb2076' => 
    array (
      0 => '/srv/sargodarya.de/www/karmalicious/smarty/templates/levels.tpl',
      1 => 1299769956,
    ),
  ),
  'nocache_hash' => '19808130274d78ea699bc039-20292038',
  'function' => 
  array (
  ),
...
Currently there are <strong><?php echo $_smarty_tpl->getVariable('levelcount')->value;?>
 levels</strong>.<br /><br />
Only as a reference, the current positive Karma amount given is <strong><?php echo $_smarty_tpl->getVariable('karmaamount')->value;?>
</strong><br />
which means the current overall community level is <strong><?php echo $_smarty_tpl->getVariable('communityLevel')->value;?>
</strong><br /><br />
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['mysec']['loop'] = is_array($_loop=$_smarty_tpl->getVariable('levels')->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
    <tr class="milestone<?php echo $_smarty_tpl->getVariable('levels')->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['milestone'];?>
"><td class="numberCell"><?php echo $_smarty_tpl->getVariable('levels')->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['level'];?>
</td><td class="numberCell"><?php echo $_smarty_tpl->getVariable('levels')->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['experience'];?>
 EXP</td><td class="numberCell">+<?php echo $_smarty_tpl->getVariable('levels')->value[$_smarty_tpl->getVariable('smarty')->value['section']['mysec']['index']]['needed'];?>
 EXP</td></tr>
    <?php endfor; endif; ?>
</table>
<br /><br />
